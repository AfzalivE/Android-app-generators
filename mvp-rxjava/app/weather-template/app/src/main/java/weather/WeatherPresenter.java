...
import <%= appPackage %>.data.source.WeatherRepository;
import <%= appPackage %>.data.source.location.LocationProvider;
import static <%= appPackage %>.util.RxUtils.applySchedulers;
import static <%= appPackage %>.util.RxUtils.observeInBackground;
import <%= appPackage %>.weather.WeatherContract.Presenter;
import <%= appPackage %>.weather.WeatherContract.View;
